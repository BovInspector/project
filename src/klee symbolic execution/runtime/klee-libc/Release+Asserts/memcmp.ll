...
bb3:                                              ; preds = %bb1
  %7 = icmp eq i32 %tmp13, %indvar, !dbg !25
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"memcmp", metadata !"memcmp", metadata !"memcmp", metadata !1, i32 42, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i32 (i8*, i8*, i32)* @memcmp} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 589865, metadata !"memcmp.c", metadata !"/home/bty/klee/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"memcmp.c", metadata !"/home/bty/klee/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
